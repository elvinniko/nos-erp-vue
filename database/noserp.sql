...
--
-- Host: 127.0.0.1:3307
-- Generation Time: May 25, 2019 at 07:33 AM
...
('KLA1', 'Baja', 'BAJ', NULL, NULL, '2019-05-07 08:17:12', '2019-05-07 08:17:12'),
('KLA2', 'Beras', 'BRS', NULL, NULL, '2019-05-07 08:17:27', '2019-05-07 08:17:27');
...
CREATE TABLE `lokasis` (
  ...
  `Tipe` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Status` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT 'Tersedia',
  `KodeUser` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('GUD-001', 'Gudang', 'INV', 'Tersedia', NULL, '2019-05-07 06:53:51', '2019-05-07 06:53:51'),
('GUD-002', 'Toko Widodo', 'INV', 'Tersedia', NULL, NULL, NULL),
('GUD-003', 'Toko Dennis', 'INV', 'Tersedia', NULL, NULL, NULL),
('GUD-004', 'Toko Bayu', 'INV', 'Tersedia', NULL, '2019-05-07 05:46:51', '2019-05-07 05:46:51');
...
('Rp', 'Rupiah', 1, NULL, NULL, '2019-05-09 05:40:06', '2019-05-09 05:40:06');
...
CREATE TABLE `pemesananpembelians` (
  ...
  `KodeSupplier` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
('Kg', 'Kilogram', NULL, NULL, '2019-05-09 06:53:43', '2019-05-09 06:53:43'),
('Kw', 'Kwintal', NULL, NULL, '2019-05-09 06:54:11', '2019-05-09 06:54:11');
...
--
-- Constraints for table `eventlogs`
--
ALTER TABLE `eventlogs`
...
--
-- Constraints for table `invoicehutangdetails`
--
ALTER TABLE `invoicehutangdetails`
...
--
-- Constraints for table `invoicehutangs`
--
ALTER TABLE `invoicehutangs`
...
--
-- Constraints for table `invoicepiutangdetails`
--
ALTER TABLE `invoicepiutangdetails`
...
--
-- Constraints for table `invoicepiutangs`
--
ALTER TABLE `invoicepiutangs`
...
--
-- Constraints for table `invopnames`
--
ALTER TABLE `invopnames`
...
--
-- Constraints for table `itemkonversis`
--
ALTER TABLE `itemkonversis`
...
--
-- Constraints for table `keluarmasukbarangs`
--
ALTER TABLE `keluarmasukbarangs`
...
--
-- Constraints for table `lokasiitems`
--
ALTER TABLE `lokasiitems`
...
--
-- Constraints for table `matauangs`
--
ALTER TABLE `matauangs`
...
--
-- Constraints for table `pelunasanhutangs`
--
ALTER TABLE `pelunasanhutangs`
...
--
-- Constraints for table `pelunasanpiutangs`
--
ALTER TABLE `pelunasanpiutangs`
...
--
-- Constraints for table `pembelianlangsungdetails`
--
ALTER TABLE `pembelianlangsungdetails`
...
--
-- Constraints for table `pembelianlangsungs`
--
ALTER TABLE `pembelianlangsungs`
...
--
-- Constraints for table `pemesananpembelians`
--
ALTER TABLE `pemesananpembelians`
...
--
-- Constraints for table `pemesananpenjualans`
--
ALTER TABLE `pemesananpenjualans`
...
--
-- Constraints for table `penjualanlangsungdetails`
--
ALTER TABLE `penjualanlangsungdetails`
...
--
-- Constraints for table `penjualanlangsungreturndetails`
--
ALTER TABLE `penjualanlangsungreturndetails`
...
--
-- Constraints for table `penjualanlangsungreturns`
--
ALTER TABLE `penjualanlangsungreturns`
...
--
-- Constraints for table `penjualanlangsungs`
--
ALTER TABLE `penjualanlangsungs`
...
--
-- Constraints for table `pindahgudangdetails`
--
ALTER TABLE `pindahgudangdetails`
...
--
-- Constraints for table `pindahgudangs`
--
ALTER TABLE `pindahgudangs`
...
--
-- Constraints for table `stokkeluardetails`
--
ALTER TABLE `stokkeluardetails`
...
--
-- Constraints for table `stokkeluars`
--
ALTER TABLE `stokkeluars`
...
--
-- Constraints for table `stokmasukdetails`
--
ALTER TABLE `stokmasukdetails`
...
--
-- Constraints for table `stokmasuks`
--
ALTER TABLE `stokmasuks`
...
--
-- Constraints for table `suratjalandetails`
--
ALTER TABLE `suratjalandetails`
...
--
-- Constraints for table `suratjalanreturns`
--
ALTER TABLE `suratjalanreturns`
