          ...
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item has-treeview menu-close">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <router-link to="/dtKlasifikasi" class="nav-link">
                    <p>Data Klasifikasi</p>
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/dtGudang" class="nav-link">
                    <p>Data Gudang</p>
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/dtSatuan" class="nav-link">
                    <p>Data Satuan</p>
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/dtItem" class="nav-link">
                    <p>Data Item</p>
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/dtPelanggan" class="nav-link">
                    <p>Data Pelanggan</p>
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/dtSupplier" class="nav-link">
                    <p>Data Supplier</p>
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/dtMataUang" class="nav-link">
                    <p>Data Mata Uang</p>
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/dtUser" class="nav-link">
                    <p>Data User</p>
                  </router-link>
                </li>
              </ul>
