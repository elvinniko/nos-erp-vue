                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                      <div class="form-group">
                        <label for="inputSJ">Nomor Surat Jalan</label>
                        <select class="form-control" id="inputSJ">
                          <option>SJ-150700005</option>
                        </select>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputSopir" placeholder="Solikin" disabled>
                      </div>
                      <div class="form-group">
                        <label for="inputNoPolisi">No Polisi</label>
                        <input type="text" class="form-control" id="inputNoPolisi" placeholder="N 1956 BA" disabled>
                      </div>
                    </div>
                    <!-- pembatas -->
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="inputAlamat" disabled>
                          <option>Talok</option>
                        </select>
                      </div>
                    </div>
